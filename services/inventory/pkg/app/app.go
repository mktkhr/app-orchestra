// Package app is the inventory service's composition root: the only public
...
// New builds the inventory service's http.Handler. Acceptance tests and
...
func build(
	...
	router, err := newRouter(handler.NewItems(store))
	if err != nil {
