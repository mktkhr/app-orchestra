 ...
 * (`make guard-layout` rejects a disabled `contained` button outright); an
 * incomplete form is rejected silently by `usePanelBuilder`'s own
 * `handleSave`, the same shape `SaveToWorkspaceControl` already uses.
 */
